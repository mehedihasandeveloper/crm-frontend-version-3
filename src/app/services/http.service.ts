...
export class HttpService {
  ...
  getQuestionListWithPagination(
    ...
    return this.httpClient.get(
      `${this.questionTableURL}/pagination/${offset}/${pageSize}`
    );
  }
  ...
  searchQuestion(term: string): Observable<any> {
    ...
    return this.httpClient.get(this.questionTableURL + '/searchQuestion', {
      params,
    });
  }
  ...
  getDataTablesListWithPagination(
    ...
    return this.httpClient.get(
      `${this.dataTableURL}/pagination/${offset}/${pageSize}`
    );
  }
  ...
  searchDataTables(term: string): Observable<any> {
    ...
    if (term && isNaN(parseInt(term, 10))) {
      params = params.set('name', term).set('campaignName', term);
    }
    ...
    return this.httpClient.get(this.dataTableURL + '/searchDataTables', {
      params,
    });
  }
  ...
  searchCampaigns(term: string): Observable<any> {
    ...
    if (term && isNaN(parseInt(term, 10))) {
      params = params.set('campaignId', term).set('campaignName', term);
    }
  ...
  getAgentListWithPagination(
    ...
    return this.httpClient.get(
      `${this.agentURL}/pagination/${offset}/${pageSize}`
    );
  }
  ...
  addDataTable(dataTables: DataTables) {
    return this.httpClient.post(
      this.dataTableURL + '/addDataTables',
      dataTables
    );
  }
  ...
  deleteDataTableById(id: any) {
    return this.httpClient.delete(
      this.dataTableURL + '/deleteDataTables/' + id
    );
  }
  ...
  addDynamicTable(data: any): Observable<any> {
    ...
    return this.httpClient.post(`${this.dynamicTableURL}/create`, null, {
      params,
    });
  }
  ...
  deleteCampaignTable(campaignName: any): Observable<any> {
    ...
    return this.httpClient.delete(this.dynamicUrl + '/deleteCampaignTable', {
      params,
    });
  }
  ...
  deleteQuestion(id: any) {
    return this.httpClient.delete(
      this.questionTableURL + '/deleteQuestion/' + id
    );
  }
  ...
  updateQuestion(question: Question) {
    return this.httpClient.put(
      this.questionTableURL + '/updateQuestion',
      question
    );
  }
  ...
  getToSetLogicQuestions(campaignId: string) {
    return this.httpClient.get(
      this.questionTableURL + '/getToSetLogic/' + campaignId
    );
  }
  ...
  getUniqueJoiningDates(tableName: string): Observable<string[]> {
    return this.httpClient.get<string[]>(
      `${this.dynamicTableURL}/unique_data_dates/${tableName}`
    );
  }

  getUniqueTargetSelector(tableName: string): Observable<string[]> {
    return this.httpClient.get<string[]>(
      `${this.dynamicTableURL}/unique_target_selector/${tableName}`
    );
  }
  ...
  generateLeads(
    tableName: string,
    dataDate: string,
    callTargets: { [key: string]: number }
  ): Observable<string> {
    const params = new HttpParams()
      .set('tableName', tableName)
      .set('dataDate', dataDate);

    return this.httpClient.post(this.generateUrl, callTargets, {
      params,
      responseType: 'text',
    });
  }
  ...
  reGenerateLeads(
    tableName: string,
    dataDate: string,
    targetSelectors: { [key: string]: number }
  ): Observable<any> {
    const params = new HttpParams()
      .set('tableName', tableName)
      .set('dataDate', dataDate);

    return this.httpClient.post(this.reGenerateUrl, targetSelectors, {
      params,
      responseType: 'text',
    });
  }
  ...
  isLogicExists(id: string): Observable<any> {
    ...
    return this.httpClient.get<any>(
      `${this.addLogicsURL}/isLogicExist`,
      options
    );
  }
  ...
  getAllCampaignLogic(campaignName: string) {
    ...
    return this.httpClient.get<any>(
      `${this.addLogicsURL}/getAllCampaignLogic`,
      options
    );
  }
  ...
  getLogicByQuestionId(questionId: string): Observable<any[]> {
    return this.httpClient.get<any[]>(
      `${this.addLogicsURL}?questionId=${questionId}`
    );
  }
  ...
  > {
    ...
    >(`${this.baseURL}/dynamic/dashboard`);
  }
  ...
  addQcReportForClient(reportData: any): Observable<any> {
    ...
    return this.httpClient.post<any>(
      this.baseURL + '/api/qcReport/addforclient',
      reportData,
      { headers }
    );
  }
  ...
  deleteQc(id: any) {
    return this.httpClient.delete(
      this.baseURL + '/api/qcReport/deleteQc/' + id
    );
  }

  deleteClientQc(id: any) {
    return this.httpClient.delete(
      this.baseURL + '/api/qcReport/deleteClientQc/' + id
    );
  }

  getQcReportsByInspector(
    username: string,
    offset: number,
    pageSize: number
  ): Observable<any> {
    const params = new HttpParams().set('username', username);
    return this.httpClient.get(
      `${this.baseURL}/api/qcReport/getqcreportbyqcinspector/${offset}/${pageSize}`,
      { params }
    );
  }

  getQcReportsClientByInspector(
    username: string,
    offset: number,
    pageSize: number
  ): Observable<any> {
    const params = new HttpParams().set('username', username);
    return this.httpClient.get(
      `${this.baseURL}/api/qcReport/getQcRecordsClientViewByQcInspector/${offset}/${pageSize}`,
      { params }
    );
  }
  ...
  private apiUrl =
    '/vicidial/non_agent_api.php?source=test&user=fifotechapi&pass=F1f0t3ch&function=user_group_status&user_groups=Virtual|InHouse&header=YES';

  getQcReportById(id: any) {
    return this.httpClient.get(this.baseURL + '/api/qcReport/getqc/' + id);
  }

  getClientQcReportById(id: any) {
    return this.httpClient.get(
      this.baseURL + '/api/qcReport/getClientQc/' + id
    );
  }
